...
export default class PetCreationViewModel {
    ...
    private _metas: Map<string, string> = new Map<string, string>()
    ...
    get weightMin(): number {
        return Number(this._metas.get(PetMinWeight))

    }

    set weightMin(value: number) {
        this._metas.set(PetMinWeight, value.toString())
    }

    get weightMax(): number {
        return Number(this._metas.get(PetMaxWeight))

    }

    set weightMax(value: number) {
        this._metas.set(PetMaxWeight, value.toString())
    }
